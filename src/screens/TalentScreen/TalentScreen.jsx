...
const TalentScreen = () => {
  ...
  hotjar.innerHTML = `
   (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:5191200,hjsv:6};
      ...
      <div className="connections-section">
        <div className="wrapper">
          <div className="connections-section-wrap">
            ...
            <div className="right-side webinar">
              <h3>Dynamic Talent is a network issue:</h3>
                ...
                <div className="form-shell">
                  <div id="mc_embed_shell">
                    <div id="mc_embed_signup">
                      <form
                        action="https://ensembleenabler.us17.list-manage.com/subscribe/post?u=23a3dfcbb4365f882ab8a864e&amp;id=b1e67698ee&amp;f_id=0033e8e3f0"
                        method="post"
